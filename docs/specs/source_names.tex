...
\end{itemize}
\item \texttt{\href{https://sicp.comp.nus.edu.sg/chapters/17\#ex_1.22}{\lstinline{get_time()}}: Returns number of milliseconds elapsed since January 1, 1970 00:00:00 UTC
...
\item \verb#is_boolean#\texttt{(x)}, \href{https://sicp.comp.nus.edu.sg/chapters/36}{\lstinline{is_number(x)}},
  \href{https://sicp.comp.nus.edu.sg/chapters/36}{\lstinline{is_string(x)}}, \verb#is_undefined#\texttt{(x)}, \verb#is_function#\texttt{(x)}:
